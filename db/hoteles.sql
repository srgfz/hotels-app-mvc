...
INSERT INTO usuarios (nombre, contraseña, fecha_registro) VALUES
  ('juan', 'password', '2022-01-01'),
  ('maria', '123456', '2022-01-02');

INSERT INTO hoteles (nombre, direccion, ciudad, pais, num_habitaciones, descripcion) VALUES
  ('Hotel 1', 'Calle 1', 'Madrid', 'España', 10, 'Este es un hotel de lujo en el centro de Madrid'),
  ('Hotel 2', 'Calle 2', 'Barcelona', 'España', 20, 'Este es un hotel con piscina en la playa de Barcelona');
